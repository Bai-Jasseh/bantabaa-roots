  ...
  return (
    <Link to="/projects/$slug" params={{ slug: project.slug }}
      ...
      <div className="relative aspect-[16/9] w-full overflow-hidden"
        style={{ background: `linear-gradient(135deg, color-mix(in oklab, ${color} 60%, var(--baobab)) 0%, color-mix(in oklab, ${color} 30%, var(--background)) 100%)` }}>
        ...
        <div className="absolute bottom-3 right-3 hidden font-display text-4xl font-bold text-white/30 sm:block" aria-hidden>{project.name[0]}</div>
      </div>
